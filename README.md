...
Linux: [![Circle CI](https://circleci.com/gh/conda-forge/r-prroc-feedstock.svg?style=shield)](https://circleci.com/gh/conda-forge/r-prroc-feedstock)
OSX: [![TravisCI](https://travis-ci.org/conda-forge/r-prroc-feedstock.svg?branch=master)](https://travis-ci.org/conda-forge/r-prroc-feedstock)
Windows: [![AppVeyor](https://ci.appveyor.com/api/projects/status/github/conda-forge/r-prroc-feedstock?svg=True)](https://ci.appveyor.com/project/conda-forge/r-prroc-feedstock/branch/master)

Current release info
====================
Version: [![Anaconda-Server Badge](https://anaconda.org/conda-forge/r-prroc/badges/version.svg)](https://anaconda.org/conda-forge/r-prroc)
Downloads: [![Anaconda-Server Badge](https://anaconda.org/conda-forge/r-prroc/badges/downloads.svg)](https://anaconda.org/conda-forge/r-prroc)
